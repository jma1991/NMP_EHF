...
<!-- ```{r} -->
<!-- file.copy("output/10-atlas-integration", "shiny/integrated/data.rds", overwrite = TRUE) -->
<!-- ``` -->
...
<!-- sce$Etv2_AND_Ednrb <- sce$Etv2 & sce$Ednrb -->
<!-- sce$source <- "ATLAS" -->
<!-- sce$source[sce$batch == "NMP_EHF"] <- "NMP_EHF_C" -->
...
<!-- source_colours <- function(x) { -->
<!--   c("NMP_EHF_C" = "#4E79A7", "ATLAS" = "#BAB0AC") -->
<!-- } -->
...
<!-- # Create iSEE object -->
<!-- ecm <- ExperimentColorMap(colData = list(celltype = celltype_colours, source = source_colours), global_discrete = boolean_colours) -->
