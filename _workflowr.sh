...
git add docs/site_libs docs/figure/01-quality-control.Rmd docs/figure/02-normalization.Rmd docs/figure/03-feature-selection.Rmd docs/figure/04-reduced-dimensions.Rmd docs/figure/05-clustering.Rmd docs/figure/06-doublet-detection.Rmd docs/figure/07-cell-cycle.Rmd docs/figure/08-marker-detection.Rmd docs/figure/09-cell-annotation.Rmd docs/figure/10-human-integration.Rmd
